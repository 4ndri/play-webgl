...
module GL {
    export module Util {
        export var ctx = null;
        export var canvas;
        export function createGLCTXByID(id:string) {
        ...
        export function CreateShaderFromFile(shaderFileName, shaderType, opt_errorCallback?: any) {
        ...
        export function createShaderFromScript(gl, scriptId, opt_shaderType?:any, opt_errorCallback?:any) {
            var shaderSource = "";
            var shaderType:any;
            ...
            return loadShader(shaderSource, opt_shaderType ? opt_shaderType : shaderType,
                opt_errorCallback);
        };
        export function CreateShaderProgram(aGL: any, ...shaders:Array<any>) {
            gl = aGL;
        ...
        var lastError = '';
        export function loadShader(shaderSource, shaderType, opt_errorCallback) {
